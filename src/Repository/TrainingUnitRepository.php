...
/**
 * @extends ServiceEntityRepository<TrainingUnit>
 *
...
class TrainingUnitRepository extends ServiceEntityRepository
{
    ...
    public function save(TrainingUnit $entity, bool $flush = false): void
    {
    ...
    public function remove(TrainingUnit $entity, bool $flush = false): void
    {
